...
namespace Demo7
{
    ...
    public class Kuvaaja : PhysicsGame
    {
        ...
        public static void LuoPisteet(PhysicsGame game, Vector[] pisteet, double r)
        {
            ...
            // TODO: Tehtävä 1
            // Ota taulukosta pisteet kukin piste ja luo sitä vastaavaan paikkaan           TEHTY
        ...
        public static int LahimmanIndeksi(Vector[] pisteet, Vector piste)
        {
            ...
            for (int i = 0; i < pisteet.Length; i++)
            {
                double kekoMuisti = Vector.Distance(pisteet[i], piste);
                if(kekoMuisti < lahinEtaisyys)
                {
                    lahinEtaisyys = kekoMuisti;
                    paikka = i;
                }
            }
            return paikka;
        ...
        public void SiirraMerkkipisteet(Vector piste)
        {
            ...
            merkkipiste.Position = pisteet[paikka];
